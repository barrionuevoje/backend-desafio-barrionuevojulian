...
const nuevaArray = async () => {
    ...
    await manejadorDeProductos.addProduct("pantalla", "pantalla",600,"sin imagen",5);


    // Se aplica método para borrar productos
     await manejadorDeProductos.deleteProduct(4);

    // // Se aplica el método updateProduct
     await manejadorDeProductos.updateProduct(5, "price", 500)
};
